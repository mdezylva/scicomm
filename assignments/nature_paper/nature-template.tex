...
These filaments contain very small amounts of matter, gas superheated to temperatures between thousands and millions of degrees, and spread out over the vast reaches of space. The combination of its speed and the distances over which it is spread, and these filaments are very sparse - only a few atoms per cubic meter. 

Searching for this gas directly proves to be very difficult. Since it doesn't emit any light itself, it cannot be detected by telescopes directly, 
